...
export const metadata = {
  ...
  description:
    "МКМ — производство мебели из массива дерева на заказ. Более 10 лет опыта, собственный цех, раскрой и кромкование на станках с ЧПУ.",
};
...
const VALUES = [
  ...
  },
  {
    ...
    title: "Точность ЧПУ",
    description:
      "Раскраиваем и кромкуем каждую деталь на станках с ЧПУ — точность, которую не даст ручной труд.",
  },
  {
    icon: Users,
      ...
      <section className="bg-beige py-16 lg:py-24">
        <Container>
          ...
          <h1 className="mt-8 max-w-3xl font-montserrat text-4xl font-bold leading-tight text-text md:text-5xl">
            Мебель на заказ с точностью до миллиметра
          </h1>
            ...
            <div>
              ...
              <div className="mt-6 space-y-4 text-base leading-relaxed text-text/70">
                <p>
                  ...
                  для полного цикла: раскрой и кромкование на станках с ЧПУ,
                  покраска, финишная отделка. Не отдаём работу на подряд —
                  делаем сами.
                </p>
                <p>
                  Наша команда — операторы ЧПУ-станков, сборщики, дизайнер и
                  технолог. Такой небольшой состав позволяет уделять внимание
                  каждому заказу и не превращать производство в конвейер.
                </p>
                <p>
